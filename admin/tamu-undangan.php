    ...
    <?php if ($success_msg): ?>
        <div style="background: rgba(46, 204, 113, 0.12); color: #2ecc71; padding: 16px 20px; border-radius: 14px; border: 1px solid rgba(46, 204, 113, 0.3); margin-bottom: 24px; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 10px;">
            ...
            <div style="display: flex; gap: 15px;">
                <a href="staging-surat.php?kegiatan_id=<?php echo $kegiatan_id; ?>" style="color: #f1c40f; text-decoration: none; font-weight: 600; font-size: 0.9rem;">
                    📩 Staging Index Surat →
                </a>
            ...
            <?php if (!empty($templates_tujuan)): ?>
                <div class="template-box">
                    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 12px; flex-wrap: wrap; gap: 8px;">
                        ...
                        <a href="pengaturan-surat.php" target="_blank" style="color: #888; text-decoration: none; font-size: 0.8rem;" title="Kelola Master Template di Pengaturan Surat">
