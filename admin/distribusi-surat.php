...
if (!$isHumas && !$isKetuplat && !$isEventHumas) {
    redirect('admin/dashboard.php', 'Akses Ditolak (Khusus Humas Kepengurusan, Ketua Pelaksana, dan Sie Humas Kegiatan)', 'error');
}
                        ...
                        <tr>
                            ...
                            <td data-label="Aksi">
                                <div class="action-btns">
                                    <a href="<?php echo (!empty($s['file_surat']) ? uploadUrl($s['file_surat']) : baseUrl('admin/cetak-surat.php?id=' . $s['id'])); ?>" target="_blank" class="btn-sm btn-download" title="Download PDF"><i class="fas fa-file-pdf"></i> Download</a>
