    ...
    <form action="cetak-lampiran-pdf.php" method="POST" target="_blank" id="printForm">
        ...
        <div class="card">
            ...
            <div class="info-grid">
                ...
                <!-- Template Picker Acara (Locked) -->
                <div class="form-group">
                    <label>Nama Acara / Kegiatan</label>
                    <input type="text" name="acara" id="input_acara" class="form-control" value="<?php echo htmlspecialchars($kegiatan['nama_kegiatan']); ?>" readonly style="background: rgba(255,255,255,0.05); color: #888;">
                </div>
            </div>
        </div>
