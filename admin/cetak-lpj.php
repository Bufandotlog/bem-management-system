        ...
        <div class="page">
            <div class="cover-page">
                <div class="cover-title">
                    ...
                    KOMISI / FRAKSI <?php echo strtoupper($k_name); ?><br>
        ...
        <div class="page">
            ...
            <?php if (!$is_mubesma): ?>
                <div style="text-align: center; margin-bottom: 25px;">
                    ...
                    <h2 style="font-size: 12pt; font-weight: bold; text-transform: uppercase;">KOMISI / FRAKSI <?php echo htmlspecialchars($k_name); ?></h2>
