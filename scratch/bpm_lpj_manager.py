...
def add_minister_cover(doc, kementerian_name, periode_years):
    ...
    run_t3 = p_title.add_run("BADAN PERWAKILAN MAHASISWA\n")
    ...
    run_s1 = p_sub.add_run("BADAN PERWAKILAN MAHASISWA\n")
...
def consolidate_lpj(output_path, file_list):
    ...
    run_mc2 = p_cover.add_run("BADAN PERWAKILAN MAHASISWA (BPM)\n")
